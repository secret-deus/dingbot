...
### 📚 专项指南
- **[Prometheus资源分析指南](./prometheus-resource-analysis-guide.md)** 📊 **NEW - 资源优化**
  - K8s集群资源利用率分析
  - 阿里云ARMS Prometheus集成
  - 智能优化建议生成
...
- **[MCP集成完整指南](./mcp-integration-guide.md)** 🔗 **MCP集成**
  - MCP协议完整支持和配置
  - 工具自动发现和同步机制
  - LLM提供商兼容性分析

### 🚀 实用工具
- **[开发与部署指南](./development-deployment-guide.md)** 🛠️ **开发必备**
  - 完整开发环境搭建
  - 生产部署配置
  - 故障排查和最佳实践
...
### 📊 已完成功能
- ✅ **Prometheus资源分析** - 集群资源利用率分析，智能优化建议 **NEW**
