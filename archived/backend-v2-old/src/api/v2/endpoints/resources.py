...
from ..dependencies import get_mcp_client as resolve_mcp_client
...
WRITE_DEPENDENCIES = [Depends(require_permission("resources:write"))]
...
@router.post("/update-metrics", response_model=ResourceUpdateResponse, dependencies=WRITE_DEPENDENCIES)
...
@router.post("/force-aggregation", dependencies=WRITE_DEPENDENCIES)
