    ...
    <el-container class="layout-container">
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'" class="sidebar">
        ...
        >
          ...
          <el-menu-item index="/dashboard-modern">
            <el-icon><Odometer /></el-icon>
            <template #title>仪表板 (现代版)</template>
          </el-menu-item>
          ...
          <el-menu-item index="/chat-modern">
            <el-icon><ChatDotSquare /></el-icon>
            <template #title>智能对话 (现代版)</template>
          </el-menu-item>
          ...
          <el-menu-item index="/settings-modern">
            <el-icon><Setting /></el-icon>
            <template #title>配置管理 (现代版)</template>
          </el-menu-item>
