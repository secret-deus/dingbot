<template>
  <div class="modern-settings">
    <div class="settings-header">
      ...
      <el-button type="primary" @click="saveAllSettings" class="modern-btn">
          ...
          <div class="card-header">
            ...
            <div class="card-header-actions">
              ...
              <div class="manual-sync-buttons">
                <el-button size="small" @click="syncFormToFile" class="modern-btn-small">
                  <el-icon><CircleCheck /></el-icon>
                  同步到文件
                </el-button>
                <el-button size="small" @click="syncFileToForm" class="modern-btn-small">
                  <el-icon><CircleCheck /></el-icon>
                  从文件同步
                </el-button>
              </div>
      ...
      <el-tab-pane label="MCP配置" name="mcp">
        <div class="config-card">
          <div class="card-header">
            ...
            <el-button size="small" @click="refreshMCPStatus" class="modern-btn-small">
              <el-icon><Refresh /></el-icon>
              刷新状态
            </el-button>
          </div>
          <div class="config-form">
            <el-form :model="mcpConfig" label-width="120px">
              <el-form-item label="超时时间:">
                <el-input-number v-model="mcpConfig.timeout" :min="1000" :max="60000" class="modern-number" />
                <span class="unit">毫秒</span>
              </el-form-item>
              <el-form-item label="重试次数:">
                <el-input-number v-model="mcpConfig.retry_attempts" :min="1" :max="10" class="modern-number" />
              </el-form-item>
              <el-form-item label="并发数:">
                <el-input-number v-model="mcpConfig.max_concurrent_calls" :min="1" :max="20" class="modern-number" />
              </el-form-item>
